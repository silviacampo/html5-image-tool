     ...
     <fieldset class="myfieldset"><legend><%=bundle.getString("add.legend")%></legend>
       ...
       <tbody>
        <tr>
         ...
         <td style="width: 442px;"><input name="name" id="name" width="100%" value="<%=n%>">
        ...
        <tr>
         ...
         <td style="width: 442px;"><textarea cols="30" rows="3" width="100%" name="description" id="description" ><%=d%></textarea>
         ...
         <td style="width: 61px;"><%=bundle.getString("add.albumDateLbl")%>
         </td>
         <td style="width: 350px;">
          <input type="text" name="albumDate" id="datepicker">
         </td>
        </tr>
        <tr>         
          <td style="width: 69px;"><%=bundle.getString("add.selectImages")%></td>
          <td colspan="3">
